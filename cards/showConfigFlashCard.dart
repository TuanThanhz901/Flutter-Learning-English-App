import 'package:final_project/pages/flash_card.dart';
...
class ShowConfig extends StatefulWidget {
  ...
  ShowConfig({Key? key, required this.topicLabel}) : super(key: key);
  @override
  _ShowConfigWidgetState createState() => _ShowConfigWidgetState();
}

class _ShowConfigWidgetState extends State<ShowConfig> {
